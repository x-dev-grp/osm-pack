...
import com.abiooc.inventory_service.dto.StockSecDto;
...
public class StockSecController extends BaseControllerImpl<StockSec, StockSecDto, StockSecDto> {
    ...
    @PatchMapping("/{articleId}/entree")
    public ResponseEntity<StockSecDto> entreeStock(
    ...
    @PatchMapping("/{articleId}/sortie")
    public ResponseEntity<StockSecDto> sortieStock(
            @PathVariable UUID articleId,
    ...
    @PatchMapping("/{articleId}/ajuster")
    ...
    @PatchMapping("/{stockId}/assigner-emplacement/{emplacementId}")
    ...
    @PatchMapping("/{stockId}/retirer-emplacement")
    ...
    @PatchMapping("/{stockId}/transferer-emplacement/{nouvelEmplacementId}")
